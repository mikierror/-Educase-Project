  ...
  return (
    <div className="w-[390px] h-[844px] border border-zinc-300 bg-gray-50 px-6 py-8 overflow-y-auto shadow-xl rounded-xl">
      <div className="h-fit w-70">
        <h2 className="text-2xl font-bold text-[#1D2226]">Sign in to your <br /> PopX account</h2>
        <p className="text-lg text-gray-600 mt-2 mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit,</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <button type="submit" className="w-full mt-2 bg-[#6C25FF] text-white py-3 rounded-md text-sm font-semibold hover:bg-purple-700 transition">
          Login
        </button>
      </form>
    </div>
